<?php
namespace ParaCore\Administrator\Config\Model;

use ParaCore\Administrator\Config\Config as ConfigBase;
use ParaCore\Administrator\Config\ConfigInterface;
use ParaCore\Administrator\Fields\Factory as FieldFactory;
use ParaCore\Administrator\Fields\Field as Field;
use ParaCore\Administrator\Actions\Factory as ActionFactory;
...
class Config extends ConfigBase implements ConfigInterface {
	 ...
	 * @param \ParaCore\Administrator\Actions\Factory	$actionFactory
	 *
	 * @return \Illuminate\Database\Eloquent\Model
	 */
