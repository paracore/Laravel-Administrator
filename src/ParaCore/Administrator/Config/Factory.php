<?php
namespace ParaCore\Administrator\Config;

use ParaCore\Administrator\Validator;
use Illuminate\Validation\Validator as CustomValidator;
use ParaCore\Administrator\Config\Settings\Config as SettingsConfig;
use ParaCore\Administrator\Config\Model\Config as ModelConfig;
...
class Factory {
	 ...
	 *
	 * @return \ParaCore\Administrator\Config\ConfigInterface
	 */
