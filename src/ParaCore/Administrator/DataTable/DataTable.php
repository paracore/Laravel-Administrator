<?php
namespace ParaCore\Administrator\DataTable;

use ParaCore\Administrator\Config\ConfigInterface;
use ParaCore\Administrator\DataTable\Columns\Factory as ColumnFactory;
use ParaCore\Administrator\Fields\Factory as FieldFactory;
...
class DataTable {
	 ...
	 *
	 * @var \ParaCore\Administrator\DataTable\Columns\Factory
	 */
	 ...
	 * The validator instance
	 *
	 * @var \ParaCore\Administrator\Fields\Factory
	 */
	 ...
	 * @param \ParaCore\Administrator\DataTable\Columns\Factory	$columnFactory
	 * @param \ParaCore\Administrator\Fields\Factory				$fieldFactory
	 */
