<?php
namespace ParaCore\Administrator\DataTable\Columns;

use ParaCore\Administrator\Validator;
use ParaCore\Administrator\Config\ConfigInterface;
use Illuminate\Database\DatabaseManager as DB;

use ParaCore\Administrator\DataTable\Columns\Relationships\BelongsTo;
use ParaCore\Administrator\DataTable\Columns\Relationships\BelongsToMany;
use ParaCore\Administrator\DataTable\Columns\Relationships\HasOneOrMany;
...
class Factory {
	 ...
	 * @param array		$options
	 *
	 * @return \ParaCore\Administrator\DataTable\Columns\Column
	 */
	...
	public function getIncludedColumns(array $fields)
	{
		...
		if (!sizeof($this->includedColumns))
		{
			...
			{
				if (is_a($field, 'ParaCore\\Administrator\\Fields\\Relationships\\BelongsTo'))
				{
