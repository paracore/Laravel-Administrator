<?php
namespace ParaCore\Administrator;
...
class Menu {
	 ...
	 * The config instance
	 *
	 * @var \ParaCore\Administrator\Config\Factory
	 */
	 ...
	 * @param \ParaCore\Administrator\Config\Factory	$config
	 */
	...
	public function getMenu($subMenu = null)
	{
		...
		foreach ($subMenu as $key => $item)
		{
			...
			if (is_string($item))
			{
				...
				if (is_a($config, 'ParaCore\Administrator\Config\Config') && $config->getOption('permission'))
				{
